...
const FinLoAnBudgets = () => {
  ...
  const fetchBudgets = useCallback(async () => {
    try {
      ...
      setError('Failed to load FinLoAn budgets');
    } finally {
      setLoading(false);
    }
  ...
  const getStatus = (spent, limit) => {
    ...
    if (percent >= 100) return finLoanColors.error;
    if (percent >= 80) return finLoanColors.warning;
    return finLoanColors.primary;
  };
    ...
    return (
      <motion.div whileHover={{ scale: 1.02 }}>
        <Card
          sx={{
            borderRadius: 3,
            borderLeft: `6px solid ${finLoanColors.primary}`,
              ...
              <Box display="flex" alignItems="center">
                <Box
                  sx={{
                    ...
                    height: 44,
                    borderRadius: '50%',
                    background: finLoanColors.light,
                    color: finLoanColors.primary,
                    display: 'flex',
                    alignItems: 'center',
            ...
            <Box mt={2}>
              ...
              <LinearProgress
                ...
                sx={{
                  ...
                  height: 8,
                  borderRadius: 4,
                  backgroundColor: finLoanColors.light,
  ...
  return (
    <Box maxWidth={1200} mx="auto">
      ...
      <Box display="flex" alignItems="center" mb={3}>
        ...
        sx={{
          mb: 3,
          background: `linear-gradient(45deg, ${finLoanColors.primary}, ${finLoanColors.secondary})`,
          borderRadius: 3,
          fontWeight: 700,
        }}
      >
      ...
      <AnimatePresence>
        {budgets.length ? (
          ...
          <Typography color="text.secondary">
            No FinLoAn budgets yet. Start planning smarter 🇮🇳
          </Typography>
        )}
      </AnimatePresence>
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} fullWidth>
        <DialogTitle>
          {editingBudget ? 'Edit Budget' : 'Create FinLoAn Budget'}
        </DialogTitle>
        <DialogContent>
