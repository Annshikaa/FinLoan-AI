...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { 
      sender: 'bot', 
  text: 'Hello! I\'m FinLoAn-AI, your financial assistant. I can help you with budgeting, expense tracking, financial planning, and answer questions about your spending patterns. How can I assist you today?',
